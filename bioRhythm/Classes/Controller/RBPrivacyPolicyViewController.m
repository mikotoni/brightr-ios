//
//  RBPrivacyPolicyViewController.m
//  Brightr
//
...
@interface RBPrivacyPolicyViewController ()
...
@implementation RBPrivacyPolicyViewController

+ (instancetype)controllerWithStoryBoard:(UIStoryboard *)storyboard {
    RBPrivacyPolicyViewController *controller = [storyboard instantiateViewControllerWithIdentifier:@"RBPrivacyPolicyViewController"];
