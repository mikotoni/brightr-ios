...
/** Block till all tasks /currently/ in the processing queue are finished.
 */
- (void) waitOnCurrentProcessingQueue;
...
@property (nonatomic, assign) bool listenToEnableNotification;
@end
